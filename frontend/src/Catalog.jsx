...
export default function Catalog() {
  ...
  const styles = {
    ...
    grid: {
      display: "grid",
      gap: 20,
      gridTemplateColumns: "repeat(5, 1fr)", // fuerza 5 columnas
      alignItems: "start",
    },
    card: {
      background: "#fff",
      ...
      <div style={styles.heroWrap}>
        ...
        <div style={styles.heroOverlay}>
          ...
          <p style={styles.heroText}>
            Typical products & souvenirs - Artesanías con historia
          </p>
        </div>
      </div>
          ...
          {products.map((product) => (
            <div key={product.id} style={styles.card}>
              ...
              <div style={styles.cardBody}>
                ...
                <button
                  onClick={() => setActiveTab(`artesano${product.id}`)}
                  style={styles.button}
                >
                  Ver más
                </button>
    ...
    <div style={styles.page}>
      <nav style={styles.nav}>
        ...
        <ul style={styles.navList}>
          <li style={styles.navItem} onClick={() => setActiveTab("home")}>
            Inicio
          </li>
          <li style={styles.navItem} onClick={() => setActiveTab("about")}>
            Sobre nosotros
          </li>
          <li style={styles.navItem}>Productos</li>
          <li style={styles.navItem} onClick={() => setActiveTab("contact")}>
            Contacto
          </li>
        </ul>
      </nav>
